...
def quad_minus(a,b,c):#this is for the subtraction half of the quadratic general solution
	root =(-b - math.sqrt((b**2) + (-4*a*c))) / (2*a)
	return str(root)

def quad_plus(a,b,c):#this is for the addition half of the quadratic general solution
	root =(-b + math.sqrt((b**2) + (-4*a*c))) / (2*a)
	return str(root)
...
root = quad_minus(a,b,c)#solves for the first half of equation
print "This is root #1: %s." % (root)
print "The  \"tpye\" of root #1 is: ", type(root)
root = quad_plus(a,b,c)#solves for the second half of equation
print "This is root #2: %s." % (root)
print "The  \"tpye\" of root #2 is: ", type(root)

from hw1 import *#problem 2 of homework


answer = ((a and b) or (not c) and not (d or e or f)) #problem 3 of homework
